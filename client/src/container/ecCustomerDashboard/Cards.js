...
import Img from '../../ImageSliderImages/house.jpg'
    ...
    return (
      <Card className={classes.card}>
        <CardHeader
          ...
          subheader={this.props.card.ow_address}
        />
        <CardMedia
        ...
        <CardContent>
          ...
          Booking Status : {this.props.card.booking_status}
          </Typography>
          <Typography component="p">
          Travelling date  {this.props.card.travel_date}
          </Typography>
        </CardContent>
